...
try:
    ...
    path = '/home/abhishek/Downloads/Attendace_management_system-master/Datasets/' + Id
    new_path = '/home/abhishek/Downloads/Attendace_management_system-master/Datasets/' + Id + '/'
    os.mkdir(path)
    sampleNum = 0
